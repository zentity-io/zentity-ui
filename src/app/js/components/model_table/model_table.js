...
export function ModelTable(props) {
      ...
      render: (name) => (
        <EuiLink name={name} onClick={(e) => props.onClickActionEdit(e.currentTarget.name)}>
          <EuiText>
            ...
            {!!props.model[props.section][name] && ( get(props.modelDiff, `added.${props.section}.${name}`) || get(props.modelDiff, `updated.${props.section}.${name}`)) &&
            <EuiBadge size='s' style={{ margin: '0 10px' }}>
              changed
            </EuiBadge>
            }
  ...
  return (<>
    ...
    {items.length === 0 && props.section == 'attributes' &&
      <EuiEmptyPrompt
        title={<EuiTitle><h3>Define Attributes</h3></EuiTitle>}
        titleSize='xs'
        body={<>
          <EuiText>
            <a href='https://zentity.io/docs/entity-models/specification/#attributes' target='_blank'>Attributes</a> are the identity elements of an entity. You will reference them in the 'resolvers' and 'indices' sections of this entity model.
            <EuiTitle size='s'>
              <h3>Examples</h3>
            </EuiTitle>
    ...
    {items.length === 0 && props.section == 'resolvers' &&
      <EuiEmptyPrompt
        title={<EuiTitle><h3>Define Resolvers</h3></EuiTitle>}
        titleSize='xs'
        body={<>
          <EuiText>
            <a href='https://zentity.io/docs/entity-models/specification/#resolvers' target='_blank'>Resolvers</a> are sets of attributes that constitute a matching document.
            <EuiTitle size='s'>
              <h3>Examples</h3>
            </EuiTitle>
    ...
    {items.length === 0 && props.section == 'matchers' &&
      <EuiEmptyPrompt
        title={<EuiTitle><h3>Define Matchers</h3></EuiTitle>}
        titleSize='xs'
        body={<>
          <EuiText>
            <a href='https://zentity.io/docs/entity-models/specification/#matchers' target='_blank'>Matchers</a> are templated Elasticsearch query clauses. You will reference them the 'indices' section of this entity model to control how zentity queries the indices.
            <EuiTitle size='s'>
              <h3>Examples</h3>
            </EuiTitle>
            <EuiBadge size='s'><a href='https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-match-query.html' target='_blank'>match</a></EuiBadge>
            <EuiBadge size='s'><a href='https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-term-query.html' target='_blank'>term</a></EuiBadge>
            <EuiBadge size='s'><a href='https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-fuzzy-query.html' target='_blank'>fuzzy</a></EuiBadge>
            <EuiBadge size='s'><a href='https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-range-query.html' target='_blank'>range</a></EuiBadge>
            <EuiBadge size='s'><a href='https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-script-query.html' target='_blank'>script</a></EuiBadge>
          </EuiText>
          <EuiSpacer size='s'/>
        </>}
        actions={
    ...
    {items.length === 0 && props.section == 'indices' &&
      <EuiEmptyPrompt
        title={<EuiTitle><h3>Define Indices</h3></EuiTitle>}
        titleSize='xs'
        body={<>
          <EuiText>
            <a href='https://zentity.io/docs/entity-models/specification/#indices' target='_blank'>Indices</a> control how zentity searches for attributes in Elasticsearch. You will associate index fields with attributes and matchers.
            <br/><br/>
            By clicking 'Create Index,' you are not creating an Elasticsearch index, but rather a definition of how zentity will search that index.
          </EuiText>
          <EuiSpacer size='s'/>
        </>}
        actions={
