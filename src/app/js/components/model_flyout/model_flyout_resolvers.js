...
export class ModelFlyoutResolvers extends ModelFlyoutAbstract {
  ...
  renderBody() {
    ...
    return (<>
      ...
      <EuiSpacer size='xs' />
      <EuiFormRow fullWidth helpText='The attributes of the resolver. During entity resolution, a document matches the entity when its fields match all the attributes of at least one resolver.'>
        <EuiComboBox
          ...
          onChange={(resolverAttributes) => {
            ...
            data.attributes = []
            for (var i in resolverAttributes)
              data.attributes.push(resolverAttributes[i].label)
